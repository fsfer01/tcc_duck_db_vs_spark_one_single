...
# ---------------------------------------------------
print("\n📥 Lendo todos os parquets em um único DataFrame...")
...
for sql_file in sql_files:
    ...
    codigo = f"pandasql_full_load_{query_name}_{tamanho_do_dado}"
    ...
    try:
        ...
        # pandasql usa o dataframe "tabela"
...
print("pandas_full_load_100gb - Todas as consultas finalizadas.")
